...
class TestMetadataManager:
    ...
    def _initialize_metadata(self):
        ...
        color_red_stimuli = [
            ...
            StimulusMetadata(3, "red", "right", 2000,
                             "ССЖ ЖСЖ ЖЖС СЖС ЖСЖ СЖК"),
            StimulusMetadata(4, "red", "center", 2400,
                             "ЖЖС СЖС ЖСС СЖЖ ЖСЖ СЖС ЖКЖ"),
            StimulusMetadata(5, "red", "right", 1200, "СЖС ЖСЖ СЖЖ ЖСК"),
            StimulusMetadata(6, "red", "center", 2400,
            ...
            StimulusMetadata(23, "red", "left", 2000,
