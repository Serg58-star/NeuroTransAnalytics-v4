...
|----------------|--------------------|------------------------|-----|
| `subject_id` | `neuro_data.db` | `users.xlsx (ID)` | int |
...
| Логическое поле | Источник данных v4 | Происхождение (legacy) | Тип |
|----------------|--------------------|------------------------|-----|
| `session_id` | `neuro_data.db` | `boxbase.xlsx (cnt)` | int |
...
|----|--------------------|------------------------|
| `stimulus_color` | `neuro_data.db` | `test_metadata_old.py` |
| `stimulus_location` | `neuro_data.db` | `test_metadata_old.py` |
...
| Поле | Источник данных v4 | Происхождение (legacy) |
|----|--------------------|------------------------|
| `test_triple` | `neuro_data.db` | `test_metadata_old.py` |
| `test_color` | `neuro_data.db` | `test_metadata_old.py` |
...
| Поле | Источник данных v4 | Происхождение (legacy) |
|----|--------------------|------------------------|
| `shift_position` | `neuro_data.db` | `test_metadata_old.py` |
| `shift_direction` | `neuro_data.db` | `test_metadata_old.py` |
...
| Тест | Происхождение (legacy) | Характер |
|----|------------------------|----------|
| Tst1 | `test_metadata_old.py` | явные |
...
| Логическое поле | Источник данных v4 | Происхождение (legacy) | Тип |
|----------------|--------------------|------------------------|-----|
| `rt_ms` | `neuro_data.db` | `boxbase.xlsx (TstX_Y)` | float |
